									...
									<div className="card-body">
										...
										<blockquote className="mb-0">
											<p className="text-muted">
												...
												divide make multiply of him
												shall itself also above second
												doesn't unto created saying land
												herb sea midst night wherein.
											</p>
							...
							<div className="col-12 col-sm-8 col-md-6 col-lg-4">
								...
								<div className="card-lg card border">
									<div className="card-body">
										...
										<blockquote className="mb-0">
											<p className="text-muted">
												God every fill great replenish
												darkness unto. Very open.
												Likeness their that light. Given
												under image to. Subdue of shall
												cattle day fish form saw spirit
												and given stars, us you whales
												may, land, saw fill unto.
											</p>
											<footer className="font-size-xs text-muted">
												Jane Jefferson,{" "}
							...
							<div className="col-12 col-sm-8 col-md-6 col-lg-4">
								...
								<div className="card-lg card border">
									<div className="card-body">
										...
										<blockquote className="mb-0">
											<p className="text-muted">
												Fill his waters wherein signs
												likeness waters. Second light
												gathered appear sixth fourth,
												seasons behold creeping female.
											</p>
											<footer className="font-size-xs text-muted">
												Darrell Baker,{" "}
